...
export EXTERNAL_DRIVE_NAME="USBDrive"
export EXTERNAL_DRIVE_PATH=${EXTERNAL_DRIVE_PATH:-"/gnupg/$EXTERNAL_DRIVE_NAME/gnupg"}
...
cat "$EXTERNAL_DRIVE_PATH/<$GNUPG_EMAIL_ADDRESS>.$GNUPG_KEY_FILE.$GNUPG_KEY_TYPE"
